...
{
    SF_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    SF_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    SF_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_CREATE");
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    SF_LOG_DEBUG("bg.battleground", "Player %s Invited %s to Join his ArenaTeam", GetPlayer()->GetName().c_str(), invitedName.c_str());
    ...
    SF_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket & /*recvData*/)
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
{
    SF_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
