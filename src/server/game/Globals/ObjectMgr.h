...
class ObjectMgr
{
    ...
    public:
        ...
        static void ChooseCreatureFlags(CreatureTemplate const* cinfo, uint64& npcflag, uint32& unit_flags, uint32& unit_flags2, uint32& dynamicflags, CreatureData const* data = NULL);
