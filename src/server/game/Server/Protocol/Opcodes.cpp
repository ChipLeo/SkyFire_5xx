...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_DISMISS_VEHICLE,               0x09FA, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleDismissControlledVehicle     ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_VEHICLE_REC_ID_ACK,        0x185B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveSetVehicleRecAck         ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTION_BAR_TOGGLES,             0x0672, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionBarToggles          ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_INSPECT_DISABLED,                   0x0002, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectDisabled              ); // 5.4.8 18414
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UPDATES,                 0x041A, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CONTROL_UPDATE,                     0x1043, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LEVEL_UP_INFO,                      0x1961, STATUS_NEVER    ); // 5.4.8 18414
