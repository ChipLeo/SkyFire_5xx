...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_REQUEST_JOURNAL,         0x0A23, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetJournal             ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DF_GET_JOIN_STATUS,                 0x032D, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleDFGetJoinStatus              ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_DISCARDED_TIME_SYNC_ACKS,           0x115B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDiscardedTimeSyncAcks        ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_PURCHASE_DENIED,     0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_PARENTAL_CONTROLS_NO_PURCHASE, 0x0000, STATUS_LOGGEDIN, PROCESS_INPLACE, &WorldSession::Handle_NULL                    );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_ALREADY_OWNED,       0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_OTHER,               0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_INSUFFICIENT_BALANCE, 0x0000, STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_BATTLEPAY_DISABLED,  0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_WRONG_CURRENCY,      0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_PAYMENT_FAILED,      0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_LE_STORE_ERROR_INVALID_PAYMENT_METHOD, 0x0000, STATUS_LOGGEDIN, PROCESS_INPLACE,    &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_COUNTDOWN_TIMER,              0x044E, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQueryCountdownTimer          ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_NPC_QUERY,                    0x1DAE, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestNPCQuery                ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_BATTLEFIELD_STATUS,         0x1F9E, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestBattlefieldStatusOpcode); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_FORCED_REACTIONS,           0x06F5, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestForcedReactionsOpcode ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                     0x158D, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix                ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SAVE_CUF_PROFILES,                  0x06E6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSaveCUFProfiles              ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SHOW_ACCOUNT_ACHIEVEMENTS,          0x0002, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleShowAccountAchievements      ); // 5.4.8 18414
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ATTACK_STOP,                        0x12AF, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOG_XP_GAIN,                        0x1E9A, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INSTANCE_INFO,                      0x16BF, STATUS_NEVER    ); // 5.4.8 18414
