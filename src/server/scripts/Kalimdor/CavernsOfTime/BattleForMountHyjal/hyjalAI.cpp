...
void hyjalAI::Retreat()
{
    if (instance)
    {
        ...
        if (Faction == 1)
        {
            ...
            if (JainaDummy)
            {
                JainaDummy->RemoveFlag64(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);
    ...
    SpawnVeins();
    Overrun = true;
    me->RemoveFlag64(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);//cant talk after overrun event started
}
