                ...
                if (caster->GetTypeId() == TYPEID_UNIT && caster->IsVehicle())
                {
                    if (Unit* charmer = caster->GetCharmer())
                    {
                        if (charmer->HasAura(SPELL_EFFECT_STOLEN_HORSE))
                        {
                            ...
                            caster->RemoveFlag64(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_SPELLCLICK);
...
public:
    ...
    struct npc_ros_dark_riderAI : public ScriptedAI
    {
        ...
        void Reset() OVERRIDE
        {
            ...
            deathcharger->RemoveFlag64(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_SPELLCLICK);
        ...
        void JustDied(Unit* killer) OVERRIDE
        {
            ...
            {
                deathcharger->SetFlag64(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_SPELLCLICK);
